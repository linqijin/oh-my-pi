...
- Added StepFun Step Plan provider catalog support with API-key discovery, seeded Step Plan models, and `STEPFUN_API_KEY` / `STEP_PLAN_API_KEY` environment fallback.
